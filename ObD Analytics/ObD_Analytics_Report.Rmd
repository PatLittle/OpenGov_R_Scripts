...
In contrast to the vast majority of records that are largely ignored, certain datasets are highly used. Below we can see the most used records on ObD, by number of downloads. 
...
We should do something to move the most used content on top platforms that will continue to be supported in the future. For other content that is getting little to no usage, it should be decommissioned. 
